...
axis([1 8000 0 1]);
hold on;
plot([0 1e-2], [0 1e-2], 'k-', 'LineWidth', 3);
plot([0 1e-2], [0 1e-2], 'k--', 'LineWidth', 3);
plot([0 1e-2], [0 1e-2], 'k-.', 'LineWidth', 3);
legend('Bayes','UCB','PAC', 'Location', 'SouthEast');
for i=1:numel(plot_idx),
    ...
    line('XData', keeps, 'YData', mean(succ_probs1(:,keeps)),...
        'Color', [c c c], 'LineWidth', 3, 'LineStyle', '-');
...
ylabel('Selection Confidence','fontsize',18);
title('Learning Rates: 10 Arms','fontsize',18);
...
xlabel('Trials Allocated','fontsize',18);
ylabel('Selection Confidence','fontsize',18);
title('Learning Rates: 20 Arms','fontsize',18);
...
xlabel('Trials Allocated','fontsize',18);
ylabel('Selection Confidence','fontsize',18);
title('Learning Rates: 50 Arms','fontsize',18);
