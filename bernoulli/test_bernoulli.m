...
arm_count = 10;
top_m = 1;
init_rounds = 30 * (group_count * arm_count);
a_0 = 1;
b_0 = 1;
...
all_sprobs1 = zeros(test_count, group_count, trial_rounds);
all_sprobs2 = zeros(test_count, group_count, trial_rounds);
...
for t_num=1:test_count
    ...
    fprintf('==================================================\n');
    bandit = bandit_maker.distro_2( 0.10, 0.01, (9/10));
    ...
    all_sprobs1(t_num,:,:) = res1.group_sprobs;
    ...
    all_sprobs2(t_num,:,:) = res2.group_sprobs;
