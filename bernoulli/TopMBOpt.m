classdef TopMBOpt < handle
    % TopMBOpt works a MultiArmBandit of type 'bernoulli'
    ...
    methods
        function [self] = TopMBOpt(ma_bandit, top_m, a_0, b_0)
            % Constructor for multiarmed bandit TopMBOpt
            if ~exist('a_0','var')
                a_0 = 2.0;
            end
            if ~exist('b_0','var')
